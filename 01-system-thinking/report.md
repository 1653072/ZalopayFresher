...
* **Cấu trúc lưu trữ của Redis gọn gàn trong 5 kiểu:** String, Hash, List, Set và Sorted Set. Xem thêm tính chất của mỗi cấu trúc [tại đây.](https://viblo.asia/p/tim-hieu-redis-databace-model-Ljy5Vepolra)
