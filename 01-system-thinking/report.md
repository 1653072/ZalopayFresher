...
- [NỘI DUNG BÁO CÁO](#A)
  - [Định lý CAP và khái niệm eventual consistency](#1)
    - [CAP](#1.1)
    - [Eventual consistency](#1.2)
  - [Khái niệm throughput và latency](#2)
    - [Throughput](#2.1)
    - [Latency](#2.2)
  - [Task Queue khác gì Message Queue](#3)
    - [Message Queue](#3.1)
    - [Task Queue](#3.2)
  - [Các phương pháp để scale database (MySQL)](#4)
    - [Master-Slave Replication](#4.1)
    - [Master-Master Replication](#4.2)
    - [Federation](#4.3)
    - [Sharding](#4.4)
  - [Khái niệm về Load balancer và NGINX](#5)
    - [Load balancer](#5.1)
    - [NGINX](#5.2)
  - [Vai trò của cache, các thuật toán apply cho cache (LRU, LFU)](#6)
    - [Vai trò của cache](#6.1)
    - [Các thuật toán dùng cho cache](#6.2)
  - [Thông tin cơ bản về Redis](#7)
    - [Khái niệm cơ bản](#7.1)
    - [Kiến trúc của Redis](#7.2)
    - [Cấu trúc lưu trữ thường dùng của Redis](#7.3)
    - [Khi nào dùng cấu trúc hyperloglog](#7.4)
- [NGUỒN THAM KHẢO](#B)
